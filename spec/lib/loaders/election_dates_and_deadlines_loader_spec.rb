...
RSpec.describe ElectionDateAndDeadlineLoader do
  ...
  describe "#save" do
    it "increases elections" do
      expect { loader.election }.to change(Election, :count).by(1)
    end
    ...
    it "didn't doesn't duplication elections" do
      expect { loader.election }.to change(Election, :count).by(1)
      expect { loader.election }.to change(Election, :count).by(0)
    end
  end
end
